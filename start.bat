...
REM
REM    This file is modified as part of fastfood branch of Openbravo POS. 2008
REM    These modifications are copyright Open Sistemas de Información Internet, S.L.
REM    http://www.opensistemas.com
REM    e-mail: imasd@opensistemas.com
REM
...
rem GroupLayout
set CP=%CP%;"%DIRNAME%lib/swing-layout-1.0.3.jar"

set CP=%CP%;"%DIRNAME%locales/"
set CP=%CP%;"%DIRNAME%reports/"

start /B javaw -cp %CP% -Djava.library.path="%DIRNAME%lib/Windows/i368-mingw32" com.openbravo.pos.forms.StartPOS
