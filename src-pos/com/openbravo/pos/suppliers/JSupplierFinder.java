...
public class JSupplierFinder extends javax.swing.JDialog implements EditorCreator {
    ...
    private void cleanSearch() {
        jListSuppliers.setModel(new MyListDataS(new ArrayList()));
    }
    
    public void executeSearch() {
        try {
            jListSuppliers.setModel(new MyListDataS(lpr.loadData()));
    ...
    private static class MyListDataS extends javax.swing.AbstractListModel {
        
        private java.util.List m_data;
        
        public MyListDataS(java.util.List data) {
            m_data = data;
        }
    ...
    private void initComponents() {
        ...
        setTitle(AppLocal.getIntString("form.supplierstitle")); // NOI18N
    ...
    private void jcmdOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jcmdOKActionPerformed
        ...
        selectedSupplier = (SupplierInfo) jListSuppliers.getSelectedValue();
        dispose();
