...
public class SuppliersView extends javax.swing.JPanel implements EditorRecord {
    ...
    public void writeValueDelete(Object value) {
        ...
        m_oId = supplier[0];
        m_jTaxID.setText((String) supplier[1]);
        m_jSearchkey.setText((String) supplier[2]);
        m_jName.setText((String) supplier[3]);
        m_jNotes.setText((String) supplier[4]);
        m_jVisible.setSelected(((Boolean) supplier[5]).booleanValue());
        jcard.setText((String) supplier[6]);
        txtMaxdebt.setText(Formats.CURRENCY.formatValue(supplier[7]));
        txtCurdate.setText(Formats.DATE.formatValue(supplier[8]));
        txtCurdebt.setText(Formats.CURRENCY.formatValue(supplier[9]));
        
        txtFirstName.setText(Formats.STRING.formatValue(supplier[10]));
        txtLastName.setText(Formats.STRING.formatValue(supplier[11]));
        ...
        txtAddress.setText(Formats.STRING.formatValue(supplier[16]));
        txtAddress2.setText(Formats.STRING.formatValue(supplier[17]));
        txtPostal.setText(Formats.STRING.formatValue(supplier[18]));
        txtCity.setText(Formats.STRING.formatValue(supplier[19]));
        txtRegion.setText(Formats.STRING.formatValue(supplier[20]));
        txtCountry.setText(Formats.STRING.formatValue(supplier[21]));

        
        m_CategoryModel.setSelectedKey(supplier[22]);
    ...
    public Object createValue() throws BasicException {
        ...
        supplier[2] = m_jSearchkey.getText();
        supplier[3] = m_jName.getText();
        supplier[4] = m_jNotes.getText();
        supplier[5] = Boolean.valueOf(m_jVisible.isSelected());
        supplier[6] = Formats.STRING.parseValue(jcard.getText()); // Format to manage NULL values
        supplier[7] = Formats.CURRENCY.parseValue(txtMaxdebt.getText(), new Double(0.0));
        supplier[8] = Formats.TIMESTAMP.parseValue(txtCurdate.getText()); // not saved
        supplier[9] = Formats.CURRENCY.parseValue(txtCurdebt.getText()); // not saved
        
        supplier[10] = Formats.STRING.parseValue(txtFirstName.getText());
        supplier[11] = Formats.STRING.parseValue(txtLastName.getText());
        ...
        supplier[16] = Formats.STRING.parseValue(txtAddress.getText());
        supplier[17] = Formats.STRING.parseValue(txtAddress2.getText());
        supplier[18] = Formats.STRING.parseValue(txtPostal.getText());
        supplier[19] = Formats.STRING.parseValue(txtCity.getText());
        supplier[20] = Formats.STRING.parseValue(txtRegion.getText());
        supplier[21] = Formats.STRING.parseValue(txtCountry.getText());

        
        supplier[22] = m_CategoryModel.getSelectedKey();
