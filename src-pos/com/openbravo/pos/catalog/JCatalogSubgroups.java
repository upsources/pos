 ...
 * @author  Mohamed Said Lokhat 	mslokhat@gmail.com
 */
public class JCatalogSubgroups extends JPanel implements ListSelectionListener, CatalogSelector {
    ...
    public JCatalogSubgroups(DataLogicSales dlSales, boolean pricevisible, boolean taxesincluded, int width, int height) {
        ...
        //tnbbutton = new ThumbNailBuilder(32, 32, "com/openbravo/images/package.png");
    }
    ...
    private void selectIndicatorPanel(Icon icon, String label) {
        ...
        m_lblIndicator.setDisabledIcon(icon);
...
*/    
    ...
    private class SmallSubgroupRenderer extends DefaultListCellRenderer {
        public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
            ...
            setText(s.getName());
            setIcon(new ImageIcon(tnbbutton.getThumbNail(s.getImage())));

            setDisabledIcon(new ImageIcon(tnbbutton.getThumbNail(s.getImage())));
            return this;
        }      
    }            
    ...
    private void initComponents() {
        ...
        m_jCancel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/button_cancel.png"))); // NOI18N
        m_jCancel.setDisabledIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/button_cancel.png"))); // NOI18N
        m_jCancel.setDisabledSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/button_cancel.png"))); // NOI18N
        ...
        m_lblIndicator.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/true.png"))); // NOI18N
        m_lblIndicator.setText("jLabel1");
        m_lblIndicator.setDisabledIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/false.png"))); // NOI18N
        ...
        m_btnBack.setDisabledIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/3uparrow.png"))); // NOI18N
        m_btnBack.setDisabledSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/3uparrow.png"))); // NOI18N
