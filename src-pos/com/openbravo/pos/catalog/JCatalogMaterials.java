 ...
 * @author adrianromero
 */
public class JCatalogMaterials extends JPanel implements ListSelectionListener, CatalogSelector {
    ...
    public JCatalogMaterials(DataLogicSales dlSales) {
        this(dlSales, false, false, 64, 54);
    }

     /** Creates new form JCatalog */
    public JCatalogMaterials(DataLogicSales dlSales, boolean  withBOM) {
        this(dlSales, false, false, 64, 54);
        this.withBOM=withBOM;

    }
    
    public JCatalogMaterials(DataLogicSales dlSales, boolean pricevisible, boolean taxesincluded, int width, int height) {
