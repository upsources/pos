 ...
 */
public class JCatalogSinglesAndMaterials extends JPanel implements ListSelectionListener, CatalogSelector {
    ...
    public JCatalogSinglesAndMaterials(DataLogicSales dlSales) {
        this(dlSales, false, false, 64, 54);
    }
    
    public JCatalogSinglesAndMaterials(DataLogicSales dlSales, boolean pricevisible, boolean taxesincluded, int width, int height) {
