 ...
 */
public class JCatalogSingles extends JPanel implements ListSelectionListener, CatalogSelector {
    ...
    public JCatalogSingles(DataLogicSales dlSales) {
        this(dlSales, false, false, 64, 54);
    }
    
    public JCatalogSingles(DataLogicSales dlSales, boolean pricevisible, boolean taxesincluded, int width, int height) {
