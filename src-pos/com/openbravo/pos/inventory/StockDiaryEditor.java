...
import com.openbravo.pos.catalog.JCatalogSinglesAndMaterials;
...
public class StockDiaryEditor extends javax.swing.JPanel implements EditorRecord {
    ...
    public StockDiaryEditor(AppView app, DirtyManager dirty) {
        ...
        m_cat = new JCatalogSinglesAndMaterials(m_dlSales);
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(261, 363));
        setPreferredSize(new java.awt.Dimension(261, 363));
