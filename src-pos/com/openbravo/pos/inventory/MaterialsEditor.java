...
public class MaterialsEditor extends JPanel implements EditorRecord {
    ...
    public Object createValue() throws BasicException {
        ...
        myprod[1] = m_jName.getText(); //Reference
        myprod[2] = m_code == null ? UUID.randomUUID().toString() : m_code; //Code
        ...
        myprod[13] = m_UnitModel.getSelectedKey();//Units
        myprod[14] = (Formats.DOUBLE.parseValue(m_jAmount.getText()) != null) ? Formats.DOUBLE.parseValue(m_jAmount.getText())   : 0.0; //Units Amount
        myprod[15] = (readCurrency(m_jPriceBuy.getText()) != null)
                ? readCurrency(m_jPriceBuy.getText())
                : 0.0; // Price buy
        myprod[16] = Formats.BYTEA.parseValue(txtAttributes.getText()); //Attributes
    ...
    private void initComponents() {
        ...
        add(jLabel2);
        jLabel2.setBounds(20, 50, 70, 25);
        add(m_jName);
        m_jName.setBounds(90, 50, 220, 25);
        ...
        m_jAmount.setBounds(160, 50, 80, 25);
        jPanel1.add(m_jCboUnit);
        m_jCboUnit.setBounds(250, 50, 80, 25);

        jLabel12.setText(AppLocal.getIntString("label.prodamount")); // NOI18N
        jPanel1.add(jLabel12);
        jLabel12.setBounds(10, 50, 120, 25);
        ...
        jTabbedPane1.addTab(bundle.getString("label.prodproperties"), jPanel3); // NOI18N
