...
//    Copyright (C) 2008 Open Sistemas de InformaciÃ³n Internet, S.L.
...
/**
 * Esta clase crea un JPanel para editar los subgrupos que contiene una composiciÃ³n 
...
//TODO Cambiar imagenes por defecto si hay otras. Cambiar tb en JCatalogSubgroups
    ...
    /**
     * Establece la composiciÃ³n que serÃ¡ objeto de ediciÃ³n
     * @param id Identificador de la composiciÃ³n
     */
...
//        showProductPanel(id);
    ...
    /*
     * Limpia los controles y carga de nuevo la informaciÃ³n de subgrupos y productos
    ...
    public void loadCatalog() throws BasicException {
        ...
        for (SubgroupInfo s: subgroups) {
            ...
            for (ProductInfoExt prod : products) {
                ...
                m_jCurrTab.addButton(new ImageIcon(tnbbutton.getThumbNailText(prod.getImage(), getProductLabel(prod))), new SelectedAction(prod));
            }
        }
...
*
     ...
     * elegir posteriormente un producto y aÃ±adirlo a un sugrupo.
     * NOTA: La categoria Composiciones no serÃ¡ incluida
     */
    private void fillCategoriesBox () {   
        //Leemos y aÃ±adimos al JComboBox las categorias
...
//        ProductInfoExt prodAll = new ProductInfoExt();  
        ...
        try {
            ...
            // Si hay algun elemento aÃ±adimos al combo la opcion "All"
/*            if (products.size() > 0) {
                prodAll.setID("all");
 ...
 */
            // AÃ±adimos la lista de productos al ComboBox
...
*/
    ...
    private void initComponents() {
        ...
        m_jbtnDelSubgroup.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/editdelete.png"))); // NOI18N
        ...
        m_jbtnSaveSubgroup.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/filesave.png"))); // NOI18N
            ...
            .add(jPanel5Layout.createSequentialGroup()
                ...
                .add(jPanel5Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                    .add(org.jdesktop.layout.GroupLayout.LEADING, jPanel5Layout.createSequentialGroup()
                        .add(m_jbtnSaveSubgroup, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 70, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.UNRELATED)
                        .add(m_jbtnDelSubgroup, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 70, Short.MAX_VALUE))
                    .add(org.jdesktop.layout.GroupLayout.LEADING, m_jLittleImageEditor, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 150, Short.MAX_VALUE)
                    .add(org.jdesktop.layout.GroupLayout.LEADING, jPanel5Layout.createSequentialGroup()
            ...
            .add(jPanel5Layout.createSequentialGroup()
                ...
                .add(jPanel5Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jPanel5Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                        ...
                        .add(m_jName, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 25, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                    .add(m_jbtnNewSubgroup, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 25, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jPanel5Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                ...
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jPanel5Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(m_jbtnSaveSubgroup, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .add(m_jbtnDelSubgroup, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 24, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        m_jbtnAddProduct.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/editnew.png"))); // NOI18N
        ...
        m_jbtnDelProduct.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/editdelete.png"))); // NOI18N
        ...
        m_jAddProductsLayout.setHorizontalGroup(
            ...
            .add(m_jAddProductsLayout.createSequentialGroup()
                .add(m_jAddProductsLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                    .add(jLabel6, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 105, Short.MAX_VALUE)
                    .add(jLabel5, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 105, Short.MAX_VALUE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(m_jAddProductsLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(m_jAddProductsLayout.createSequentialGroup()
                        .add(m_jbtnAddProduct, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 70, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.UNRELATED)
                        .add(m_jbtnDelProduct, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 70, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                    .add(m_jCategory, 0, 206, Short.MAX_VALUE)
        ...
        m_jAddProductsLayout.setVerticalGroup(
            ...
            .add(m_jAddProductsLayout.createSequentialGroup()
                ...
                .add(m_jAddProductsLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    ...
                    .add(m_jCategory, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 25, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(m_jAddProductsLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(jLabel6, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 25, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                    .add(m_jProduct, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 25, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(m_jAddProductsLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(m_jbtnAddProduct, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 25, Short.MAX_VALUE)
                    .add(m_jbtnDelProduct, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 25, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
...
//
    ...
    /*
     * Boton salvar un subgrupo (aÃ±adir o modificar)
     */
    private void m_jbtnSaveSubgroupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_jbtnSaveSubgroupActionPerformed
        ...
        if (!(name.length()==0)) {
            ...
            if (m_selSubgr != null) { //Si es una modificacion
                //Eliminamos el subgrupo antiguo de la lista y aÃ±adimos el editado
                m_subgroupsset.remove((SubgroupInfo) m_jListSubgroups.getSelectedValue()); 
                m_subgroupsset.add(s);
    ...
    /*
     * Boton aÃ±adir producto a un subgrupo
     */
    private void m_jbtnAddProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_jbtnAddProductActionPerformed
        if (m_selProd != null && m_selSubgr != null) {
            ...
            m_jCurrTab.addButton(new ImageIcon(tnbbutton.getThumbNailText(m_selProd.getImage(), getProductLabel(m_selProd))), new SelectedAction(m_selProd));
            m_jCurrTab.updateUI();
            m_dirty.setDirty(true);
        } else {
