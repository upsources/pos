...
// TO DO : change the tax coding to new one
...
*/    
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel4);
        jLabel4.setBounds(10, 50, 150, 25);

        m_jPriceSell.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        jPanel1.add(m_jPriceSell);
        m_jPriceSell.setBounds(160, 50, 80, 25);
        ...
        m_jCategory.setBounds(160, 140, 170, 25);

        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("pos_messages"); // NOI18N
        jLabel7.setText(bundle.getString("label.taxcategory")); // NOI18N
        jPanel1.add(jLabel7);
        jLabel7.setBounds(10, 110, 150, 25);
        jPanel1.add(m_jTax);
        m_jTax.setBounds(160, 110, 170, 25);

        m_jPriceSellTax.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        jPanel1.add(m_jPriceSellTax);
        m_jPriceSellTax.setBounds(160, 80, 80, 25);

        jLabel16.setText(AppLocal.getIntString("label.prodpriceselltax")); // NOI18N
        jPanel1.add(jLabel16);
        jLabel16.setBounds(10, 80, 150, 25);
        ...
        m_jInCatalog.setBounds(160, 20, 50, 25);
        jPanel4.add(m_jComment);
        m_jComment.setBounds(160, 50, 80, 25);
        ...
        m_jCatalogOrder.setBounds(310, 20, 80, 25);

        jLabel18.setText(AppLocal.getIntString("label.prodorder")); // NOI18N
        jPanel4.add(jLabel18);
        jLabel18.setBounds(250, 20, 60, 25);
        ...
        jTabbedPane1.addTab(bundle.getString("label.attributes"), jPanel3); // NOI18N
