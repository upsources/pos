...
public class ReceiptSplit extends javax.swing.JDialog {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        List<TicketLineInfo> lines = receiptone.getAffectedLines();
        if (lines != null && lines.size() > 0) {
            receipttwo.addAffectedLines(lines);
        }       
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        List<TicketLineInfo> lines = receiptone.getAffectedLinesUnit();
        if (lines != null && lines.size() > 0) {
            receipttwo.addAffectedLines(lines);
        }    
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        List<TicketLineInfo> lines = receipttwo.getAffectedLinesUnit();
        if (lines != null && lines.size() > 0) {
            receiptone.addAffectedLines(lines);
        }   
