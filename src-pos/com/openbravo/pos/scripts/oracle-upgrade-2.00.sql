...
ALTER TABLE CUSTOMERS ADD COLUMN TAXID VARCHAR2(255);  
...
ALTER TABLE PRODUCTS ADD COLUMN ATTRIBUTES BLOB;

ALTER TABLE TICKETS ADD COLUMN CUSTOMER VARCHAR2(255);
...
ALTER TABLE TICKETLINES ADD COLUMN ATTRIBUTES BLOB;
