...
ALTER TABLE PEOPLE ADD MAXDEBT DOUBLE PRECISION DEFAULT 0 NOT NULL;  
ALTER TABLE PEOPLE ADD CURDATE TIMESTAMP;  
ALTER TABLE PEOPLE ADD CURDEBT DOUBLE PRECISION;
