...
//TODO
import com.openbravo.pos.ticket.CompositionFilterSales;
 ...
 */
public class JCompositionFinder extends javax.swing.JDialog {

    private ProductInfoExt m_ReturnProduct;
    private ListProvider lpr;
    
    /** Creates new form JCompositionFinder */
    private JCompositionFinder(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    }
    /** Creates new form JCompositionFinder */
    private JCompositionFinder(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
    }    
...
//TODO
        //CompositionFilter jCompositionFilter = new CompositionFilter(app);
        CompositionFilterSales jCompositionFilter = new CompositionFilterSales(dlSales, m_jKeys);
        jCompositionFilter.activate();
        m_jProductSelect.add(jCompositionFilter, BorderLayout.CENTER);
        
        lpr = new ListProviderCreator(dlSales.getCompositionList(), jCompositionFilter);   
    ...
    public static ProductInfoExt showMessage(Component parent, DataLogicSales dlSales) {
        ...
        JCompositionFinder myMsg;
        if (window instanceof Frame) { 
            myMsg = new JCompositionFinder((Frame) window, true);
        } else {
            myMsg = new JCompositionFinder((Dialog) window, true);
        }
