 ...
 * @author adrianromero
 */
public class JAuxiliarFinder extends javax.swing.JDialog {

    private ProductInfoExt m_ReturnProduct;
    private ListProvider lpr;
    
    /** Creates new form JProductFinder */
    private JAuxiliarFinder(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    }
    /** Creates new form JProductFinder */
    private JAuxiliarFinder(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
    }    
    ...
    public static ProductInfoExt showMessage(Component parent, DataLogicSales dlSales) {
        ...
        JAuxiliarFinder myMsg;
        if (window instanceof Frame) { 
            myMsg = new JAuxiliarFinder((Frame) window, true);
        } else {
            myMsg = new JAuxiliarFinder((Dialog) window, true);
        }
