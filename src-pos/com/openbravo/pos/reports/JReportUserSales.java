...
public class JReportUserSales extends JPanelReport {
    ...
    protected BaseSentence getSentence() {
        return new StaticSentence(m_App.getSession()
            , new QBFBuilder(
                "SELECT PEOPLE.NAME, MIN(RECEIPTS.DATENEW) AS STARTDATE, MAX(RECEIPTS.DATENEW) AS ENDDATE, SUM(TICKETLINES.UNITS * TICKETLINES.PRICE) AS TOTAL " +
                ...
                "GROUP BY PEOPLE.NAME ORDER BY PEOPLE.NAME",  new String[] {"RECEIPTS.DATENEW", "RECEIPTS.DATENEW"})
