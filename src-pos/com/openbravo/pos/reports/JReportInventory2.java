...
public class JReportInventory2 extends JPanelReport {
    ...
    protected String getReport() {
        return "/com/openbravo/pos/reports/inventory2";
    }

    protected String getResourceBundle() {
        return "report_inventory2_messages";
    }
    ...
    protected BaseSentence getSentence() {
        return new StaticSentence(m_App.getSession(),
                ...
                "WHERE ?(QBF_FILTER) " +
                "ORDER BY CATEGORIES.NAME, PRODUCTS.NAME, STOCKCURRENT.LOCATION", new String[]{
            ...
            "STOCKCURRENT.LOCATION"
                ...
                new Datas[]{Datas.OBJECT, Datas.STRING}), new SerializerReadBasic(new Datas[]{Datas.STRING, Datas.STRING, Datas.STRING, Datas.STRING, Datas.STRING, Datas.STRING, Datas.DOUBLE, Datas.DOUBLE, Datas.DOUBLE}));
    }
