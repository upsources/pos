 ...
 * @author adrianromero
 */
public class DataLogicIntegrationOracle extends DataLogicIntegration {
    
    /** Creates a new instance of DataLogicIntegrationHSQLDB */
    public DataLogicIntegrationOracle() {
    }
    
    @Override
    public void syncCustomersBefore() throws BasicException {
        new StaticSentence(s, "UPDATE CUSTOMERS SET VISIBLE = 0").exec();
    }
        ...
        Transaction t = new Transaction(s) {
            public Object transact() throws BasicException {
                ...
                if (new PreparedSentence(s, 
                            "UPDATE CUSTOMERS SET SEARCHKEY = ?, NAME = ?, NOTES = ?, VISIBLE = 1 WHERE ID = ?", 
                    ...
                    new PreparedSentence(s, 
                            "INSERT INTO CUSTOMERS(ID, SEARCHKEY, NAME, NOTES, VISIBLE) VALUES (?, ?, ?, ?, 1)", 
                            SerializerWriteParams.INSTANCE
                            ).exec(new DataParams() { public void writeValues() throws BasicException {
